...
def get_losses(pointclouds_pl, end_points, dir_labels_pc_cam, offset_labels_pc, grasp_success_labels_pc, approach_labels_pc_cam, global_config):
    ...
    print_op = tf.print('raw losses: ', dir_cosine_loss, bin_ce_loss, offset_loss, approach_cosine_loss, adds_loss,
                        adds_loss_gt2pred, output_stream=sys.stdout)
    return dir_cosine_loss, bin_ce_loss, offset_loss, approach_cosine_loss, adds_loss, adds_loss_gt2pred, print_op
